...
<div class="banner_bottom_agile_info">
    <div class="container">    
		...
		<div class="col-md-12 wthree_banner_bottom_grid_three_left1 grid" style="margin-top:20px">
			<figure class="effect-roxy">
				<img src="images/bottom2.jpg" alt=" " class="img-responsive" />
				<figcaption>
					<h3><span>F</span>lyer</h3>
...
<div class="schedule-bottom">
    ...
    <div class="col-md-6 agileits_schedule_bottom_right">
        <div class="w3ls_schedule_bottom_right_grid">
            ...
            <p>Kami mencoba memberikan yang terbaik</p>
...
<div class="banner-bootom-w3-agileits">
    <div class="container">
        <h3 class="wthree_text_info">Portofolio <span>Kami</span></h3>
...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<h3 class="wthree_text_info">FAQ </h3>
